    ...
    <div className="inner_page_banner">
                     ...
                     <Image src="/images/product.jpg" className="img-responsive banner_img" width={1351} height={120} alt="Customization"/>
                            ...
                            <div className="container">
                                <h2>Digital Marketing & Growth</h2>
                                </div>
                            </div>							
                         </div>
                ...
                <div className="right_panel">
                    ...
                    <div className="programming_platforms_list">
                        <ul className="nav nav-pills nav-stacked " id="tab">
                            ...
                            <Link href="/success-stories/erp-modernization" >ERP Modernization</Link></li>
                            <li role="presentation" >
                            <Link href="/success-stories/warehouse-and-supply-chain-automation">Warehouse & Supply Chain Automation</Link></li>
                            <li role="presentation" ><Link href="/success-stories/custom-web-and-mobile-apps">Custom Web & Mobile Apps</Link></li>
                            <li role="presentation" className="active"><Link href="/success-stories/digital-marketing-and-growth">Digital Marketing & Growth</Link></li>
                            <li role="presentation"  ><Link href="/success-stories/cybersecurity-and-compliance">Cybersecurity & Compliance</Link></li>
                            <li role="presentation" ><Link href="/success-stories/cloud-migration-and-devops">Cloud Migration & DevOps</Link></li>
