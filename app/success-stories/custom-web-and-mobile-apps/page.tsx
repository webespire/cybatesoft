                ...
                <div className="right_panel">
                    ...
                    <div className="programming_platforms_list">
                        <ul className="nav nav-pills nav-stacked " id="tab">
                            ...
                            <li role="presentation" className="active"><Link href="/success-stories/custom-web-and-mobile-apps">Custom Web & Mobile Apps</Link></li>
                            <li role="presentation" ><Link href="/success-stories/digital-marketing-and-growth">Digital Marketing & Growth</Link></li>
