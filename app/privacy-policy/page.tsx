...
export default function page() {
  return (
    ...
    <br/><br/><br/><br/>
 <center><div>
<h1 style={{color:'#224ca2'}}>PRIVACY POLICY</h1>
<h4 style={{color:'#003c54'}} > Coming Soon..................</h4>
<p>We are updating content soon...! Thanks for your visit...!!</p>

            	<div>
					<Link href="/" title="go back  to home page" className="btn btn-primary btn-lg active" role="button">GO BACK TO HOME PAGE</Link> 
            	</div>
