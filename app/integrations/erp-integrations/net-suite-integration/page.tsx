                ...
                <div className="right_panel">
                    ...
                    <div className="programming_platforms_list">
                        <ul className="nav nav-pills nav-stacked " id="tab">
                            ...
                            <li role="presentation"  ><Link href="/integrations/erp-integrations/oracle-fusion-cloud-erp-integration">Oracle Fusion Cloud ERP Integration</Link></li>
                            <li role="presentation" className="active" ><Link href="/integrations/erp-integrations/net-suite-integration">NetSuite Integration</Link></li>
