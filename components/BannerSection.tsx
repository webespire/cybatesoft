...
//   {
//     id: 2,
//     title: "Optimize operations with Business Process Automation solutions.",
//     image: "/media/logo/business.jpg",
//     label: "Business Process Automation",
//   },
//   {
//     id: 3,
//     title: "Enhance teamwork using modern collaboration platforms.",
//     image: "/media/logo/col.jpg",
//     label: "Collaboration",
//   },
//   {
//     id: 4,
//     title: "Drive transformation with Microsoft Dynamics 365.",
...
//       <div className="row">
//         {/* LEFT SIDE SLIDER */}
//         <div className="col-xl-12 col-md-12 col-sm-12 pd4">
//           <div className="hero">
      ...
      <div className="row">
        <div className="col-xl-12 col-md-12 col-sm-12 pd4">
          <div className="hero">
            ...
            ========================== */}
            <div className="hero-side-nav desktop-side-nav">
              <div className="hero-side-track">
                <div
                  className="hero-side-indicator"
                  style={{
              ...
              <ul className="hero-side-steps">
                {slides.map((slide, index) => (
                  <li
                    ...
                    onClick={() => setActive(index)}
                  >
                    <span className="hero-side-num">{slide.id}</span>
                    <span className="hero-side-label">{slide.label}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* =========================
                MOBILE BOTTOM NAV
            ========================== */}
            <div className="hero-bottom-nav mobile-bottom-nav">
              {/* Horizontal Track */}
              <div className="hero-bottom-track">
                <div
              ...
              <ul className="hero-bottom-steps">
                {slides.map((slide, index) => (
                  <li
                    key={slide.id}
                    className={index === active ? "active" : ""}
                    onClick={() => setActive(index)}
                  >
                    <span className="hero-bottom-num">{slide.id}</span>
                    <span className="hero-bottom-label">{slide.label}</span>
                  </li>
                ))}
              </ul>
            </div>
